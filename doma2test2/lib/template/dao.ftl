...
<#-- importにConfigAutowireableを追加 -->
<#if !importNames?seq_contains("org.seasar.doma.boot.ConfigAutowireable")>
<#assign importNames = importNames + ["org.seasar.doma.boot.ConfigAutowireable"]>
</#if>
